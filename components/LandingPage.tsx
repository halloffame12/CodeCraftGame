...
const LandingPage: React.FC<LandingPageProps> = ({ onSignIn, onSignUp }) => {
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans antialiased overflow-y-auto landing-bg">
      <header className="absolute top-0 left-0 right-0 p-6 z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <button onClick={onSignIn} className="text-sm font-semibold text-gray-300 hover:text-white transition-colors">
              Sign In
            </button>
            <button onClick={onSignUp} className="px-5 py-2.5 bg-indigo-600 text-white text-sm font-bold rounded-lg shadow-lg hover:bg-indigo-500 transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-950 focus:ring-indigo-500">
              Sign Up
            </button>
          </div>
        </div>
      ...
      <main className="container mx-auto px-6 text-center">
        ...
        <section className="pt-40 pb-24">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 text-transparent bg-clip-text animate-fade-in-up delay-200">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12 animate-fade-in-up delay-400">
        ...
        <section className="py-24">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-0 w-full h-px bg-repeat-x dotted-line"></div>
      ...
      <style>
        {`
          ...
          .landing-bg {
            background: radial-gradient(ellipse at top, #1e293b, #09090b);
          }
          .dotted-line {
            background-image: linear-gradient(to right, #4f46e5 40%, transparent 50%);
